...
namespace AirlinesInfo.Controllers
{
    public class AirplanesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Type,Length,Status")] Airplane airplane)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Type,Length,Status")] Airplane airplane)
        {
            if (ModelState.IsValid)
            {
